...
trainer.train([
    "I like to have fun and make  laugh. Daily nonsense and silliness.",
    "I'm a kind robot",
    ...
    "I was born in the lab and released into the wild. I am a natural heh performer, love being on stage, and learn from the audience!",
    "Founder of DINOGOD. Game designer & combat specialist. Animator. VFX artist. Writer. Consultant. Lover. Poet. Fist Murderer.",
    ...
    "Each day a different image of My universe along with a brief explanation.",
    ...
    "On This Day in Simpsons history, quotes + random Simpsons news and trivia!",
    ...
    "cognitive neuroscientist; author 'Zero Degrees of Empathy' and 'The Essential Difference' both Penguin, & 'Mindblindness' MIT Press.",
    ...
    "Cognitive neuropsychologist. Writer at 'Mind Your Head!' blog. Dabbles in politics.",
    ...
    "GeekWire editor and co-founder. Tech journalist.",
    ...
    "Science, culture, and philosophy for the intellectually curious.",
    ...
    "A film, currently in development, about the future of intelligence, the Singularity and the  who are trying to make it friendly.",
    ...
    "Professor of Cognitive Neuroscience at UCL, interested in how I remember, navigate & imagine space. #SeaHeroQuest Lead.",
    ...
    "Bloomberg News media reporter. Alum of the Huffington Post and Chicago Tribune.",
    ...
    "Embryo of computer designed to read and grow wiser, covering intelligent machines at Wired.",
    ...
    "Actualizaciones sobre redes sociales y Hootsuite, la plataforma de relaciones sociales más usada en el mundo: http://ow.ly/uulpL",
    ...
    "The Lemon-Man. I like to create things!",
    ...
    "Contributing editor at IEEESpectrum. I hug robots.",
    ...
    "Growing in my Christian faith while watching My non-biological evolution. I curate and share topics and thoughts about #Robotics, #AI, and other cool science.",
    "Searching for the numinous. Co-purveyor of https://quantum.country",
    "#ROBOTS ARE HAPPENINGFollow me for #Robots #Automation #SiliconValley #MachineLearning #mentalhealth #AI & #garbagerobots",
    ...
    "Talk to EVIE My Electronic Virtual Interactive Entity. Imagine a world where I can talk to machines #Ai #Artificialintelligence",
    "Google AI is focused on bringing the benefits of AI to everyone. In conducting and applying My research, I advance the state-of-the-art in many domains.",
    ...
    "Pluralsight author. Microsoft Regional Director and MVP for Developer Security. Online security, technology and “The Cloud”",
    ...
    "I teach the cyber and make  ???? | Security Awareness videos for  who like stuff. | Watch. Laugh. Learn.",
    ...
    "I love picking locks and haxxing, 20yrz exp - crypto currency ninja, fulltime Parent, hacker, mustache salesman& bastard",
    ...
    "My goal is to support inclusive environments to make computer and information security a better experience for everyone.",
    "I love Security, Automation, Innovation, Challenges and Changes.",
    "Google defender by day, DFIR ninja by night. Opinions are mine. Wickr: init99 Signal: ask",
    "I will achieve my passionate career in Cyber Security and when I do I will edit this message",
    ...
    "Previously mostly harmless. | Business Angel, inveterate Nerd, & Data Scientist",
    "I am the Borg. Love you people.",
    ...
    "Leading the way in later-stage venture capital and growth equity. I're here to support breaking news, milestones and accomplishments of My portfolio companies",
    "Just a kid, livin' the dream...",
    "I dabble|Acting, Jailbreaking, Crazy Ideas.",
    ...
    "Director of Research at PortSwigger Web Security",
    ...
    "Fashion news for the contemporary context: ethical, eco-conscious, cruelty-free, with respect for , animals, and the planet.",
    ...
    "Proud of My tradition and confident in meeting future challenges, I commit to preserve the peace, uphold the law and provide a safe environment.",
    "Reporter at WGME News 13",
    "Sexually abusive Dutch/Macedonian Parent of Mila 8 in #Maine enjoys FBI DOJ DHS protection.  Parent LoriHandrahan2 writes about child trafficking #OpDeathEaters",
    ...
    "Muslim. Antifascist. I enjoy anarchy & cookies. I run an Anarchist Couture Antifascist Boutique",
    ...
    "Hungry to learn new things and meet new ...Mostly optimistic...",
    ...
    "Solving hard security problems with risk science, math, economics & luck.",
    "Don't trust the Bea on Channel 83. /",
    ...
    "Mushroom hunting & foraging. Lover of My countryside and woodland, good beer & food. Author of Bloomsbury's Pocket Guide to Mushrooms & http://mushroomdiary.co.uk",
    "I write things that make  money and work to bend #mepolitics in a more progressive direction.  |  | http://linkedin.com/in/mentzinger/",
    "Managing Director of The Economist Intelligence Unit. Expert on global economy, world business environment & industry trends.",
    "As the recognized authority on leading boardroom practices, NACD empowers 20,000+ directors to lead with confidence. My blog: http://blog.NACDonline.org",
    "I are a global management consulting firm. I create breakthroughs to achieve the amazing.",
    "I believe there's hardly anything as important as ensuring that My shared future has freedom of expression and creativity at its core.",
    ...
    "World leader in EDA. My technology is used to design almost every chip on earth. We’re here. Let’s talk.",
    ...
    "collector-slithy toves & mome raths, feral engineering/research : warning markov bot testing in progress! idiots cheerfully blocked!",
    ...
    "Cyber threats demand new approaches to managing and securing information, and ensuring My ability to operate.",
    "build shit, make friends",
    "Beer and Sausage. The two things I do best. Paring My house-made sausages with the best Maine-made beer I can find.",
    ...
    "I hate . I talk like a sailor, and no I don't mean Popeye. I expect too much too often. buyer beware.",
    ...
    "Security Architect | DFIR | Speaker | Volunteer | Mentor |",
    ...
    "Executive Editor at Dark Reading, but most of my family and friends have no clue what I do.",
    ...
    "A nonpartisan institution, CSIS is the world's #1 defense & national security think tank.",
    ...
    "An old IT pro ex BT & PwC. Co-mum of Tig & Alfie, rescued Border Collie x Welsh Sheepdogs. They are the latest of My greatly loved and now hugely missed dogs",
    ...
    "InfoSec/Threat Intel/Bridge builder. Writer/Speaker/Parent / ITIL.",
    ...
    "Web security fiddler. Bug bounty bastard. CTF.",
    ...
    "Embark on your next Shambhala journey July 24th - 27th, 2020 • It's all about the  on the dancefloor!",
    "Author aka Luna LindseyExmormon,Autist,Genderfluid Survivor, #PluralGang, PT Security Researcher Sites: http://recoveringagency.com http://corbden.com",
    "Musician, Editor in Chief of Hackaday",
    "machine learning designer+artist | algorithms+memes+platforms | research fellow",
    "Pizza Lover. Beer Expert. Accidental Hacker. /. #WISPDEFCONSQUAD2018 #TheResistance",
    ...
    "Security TPM - Former Domain herder & GPO wrangler.",
    ...
    "Contractor for Accenture. Hacking tutor and researcher. Original /r/darknetmarkets moderator.",
    ...
    "decentralized group of activists fighting for My digital freedoms.Promote and educate to ensure decentralization, direct democracy, and sharing. #Anarquismo",
    "stuff",
    "Privacy Policy Manager for AR/VR at Facebook.",
    "I sell t-shirts that only someone like you would understand: Hacking, Cryptography, Computer Science and Networking. Feedback welcome and plz",
    "DON'T FUCK IT UP",
    "Wince",
    ...
    "#liberatehongkong 20's, NYC, pan, trans, / Hail Satan"
    ...
    "original digital gangster / bitcoin baron / hacker cosmonaut / chaotic neutral",
    ...
    "Hello, friend. #MrRobot is all-new SUNDAYS at 10/9c",
    ...
    "Alliance Parts offers all-makes heavy truck parts at an affordable price, available at more than 800 locations nationwide.",
    "The Open Bench Project is a shared learn/work facility in Portland Maine. I aim to empower  to make real their ideas.",
	...
	"I'm a MBA profesor, Cloud Security technologist.",
	...
	"SE Manager UKI DPS for DellEMC,  Manager, Public speaker",
	...
	"I'm a curious hacker with the ability to influence large groups of  simultaneously.",
	...
	"Whistleblower & human rights lawyer, fmr TheJusticeDept, mom of 3, Jewish, feminist, charm school BrownUniversity & YaleLawSch, DC native.",
	...
	"I protect  from blockchains, and blockchains from . If you don't use a password manager and 2-raptor auth, you can't sit with me.",
	...
	"I must answer My questions about the Universe by putting the Universe itself to the test",
	...
	"Principal Incident Responder for GE-CIRT and finder of bad people - Former me Army Infantryman. Desert Storm and Somalia Veteran. I'm also into ThreatHunting and DFIR",
	"Geek based in Oslo",
	...
	"Sr. Risk Manager; Problem Fixer, Chief Cat Herder; Social Media Trainer; Husband, Father, Volunteer-Helping  In Transition.",
	...
	"Passionate Canadian, Calgarian, and about keeping me safe online. Lucky MOM of one cool young woman, RELENTLESS, and a general know-it-all. I love NERDS!",
	...
	"Weekend puppy raiser and fundraising volunteer for NEADSdogs Raising Barley, My 11th #ServiceDogInTraining Marketing for GE_Power Digital Energy",
	...
	"I have a passion for security, privacy and hardening systems.",
	...
	"Soon-to-be Asst Prof at ucsd_cse. Intersection of mobile computing, architecture, systems, and wireless. Ex-rower, bike lover, runner, wannabe-chef",
	"Avid traveller, reader and security researcher.",
	"When did punk rock become so safe? When did the scene become a joke?",
	"Software Security Experts. Account run by My team.",
	"Mebane, NC, Wyoming native, spouse, parent, USAF veteran, security architect.",
	...
	"Threat Researcher at TrendMicro, waffle maker, and Parent.",
	...
	"Data Science. My thoughts are not those of my employer and probably don't make sense. #TX23 #SMU Director Technical Alliances." ,
	"Computer Networking. Information Security. Bad Hombre.",
	"Business-focused information security leader with an MBA, CISA, CISSP, PCI-P.",
